...
class chiral_nematic_simulation_method():
    def __init__(self):
        ...
        self.materials()
        self.set_wave_vector()

    def set_wave_vector(self, wavelength_range=(300e-9, 800e-9), n_wavelengths=500, incident_angle = 0):
        # Normal incidence, Reduced incidence wavenumber
        # Kx determines the angle of incidence
        # 'Phi' is the angle of the wavetraveling to the right with respect to the horizontal.
        self.Kx = sin(incident_angle*pi/180)
    ...
    def materials(self):
        ...
        #PET oriented along the x direction - birefringent
        self.aligned_PET = Berreman4x4.UniaxialNonDispersiveMaterial(1.8, 1.6)
    ...
    def export_data_to_csv(self):
        ...
        print('saved to ' + self.folder +'\\'+ self.output_filename)
